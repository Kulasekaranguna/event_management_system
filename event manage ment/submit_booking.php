...
$categoryOptions = array("0" => "Select", "20000" => "Marriage", "12000" => "Reception", "15000" => "Sports Event", "21000" => "Cultural Festival","10000" => "Birthday Party");
...
$categoryText = isset($_POST["category"]) ? $categoryOptions[$_POST["category"]] : "";
...
$totalCost += $categoryText != "No" ? array_search($categoryText, $categoryOptions) : 0;
...
$insertQuery = "INSERT INTO bookings (bookername, category, place, guests, date, dj, stage, sound, breakfast, lunch, tea, dinner, veg, nonveg, light, flowers, seat, foodtype, total_cost)
VALUES ('$bookername', '$categoryText', '$place', $guests, '$date', '$dj', '$stage', '$sound', '$breakfast', '$lunch', '$tea', '$dinner', '$veg', '$nonveg', '$lightText', '$flowersText', '$seatText', '$foodTypeText', $totalCost)";
